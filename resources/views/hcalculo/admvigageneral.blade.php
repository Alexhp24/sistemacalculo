<x-app-layout>
                            ...
                            <form id="FlexionViga" method="post">
                                ...
                                <div class="col-md-3">
                                    <div class="input-group mb-2">
                                        <button id="accionButton" class="bg-blue-500 hover:bg-blue-400 text-white font-bold py-2 px-4 border-b-4 border-blue-700 hover:border-blue-500 rounded" type="button">DISEÑAR</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                ...
                <div class="w-full md:w-2/3 px-4 mt-4 md:mt-0">
                    <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg p-6">
                        ...
                        <div class="overflow-x-auto">
                            ...
                            <div id="calc_vigas_verf" style="overflow-x: auto; overflow-y: hidden; max-width: 100vw;"></div>
    ...
    <script src="{{ asset('assets/js/adm_vigas_general.js') }}"></script>
