<x-app-layout>
                            ...
                            <table class="table-fixed w-full text-gray-800 dark:text-white px-6">
                                ...
                                <tbody class="text-center">
                                    ...
                                    <tr class="bg-white dark:bg-gray-800">
                                        ...
                                        <th class="py-2 px-4">
                                            <input type="text" name="alturacolumna" class="form-control w-full bg-gray-50 dark:bg-gray-700 text-gray-800 dark:text-gray-200 p-2 px-1 rounded-md" id="alturacolumna" placeholder="8" min="0" value="8" required>
                                        </th>
                                    ...
                                    <tr class="bg-white dark:bg-gray-800">
                                        ...
                                        <th class="py-2 px-4"><input type="text" name="cargaviento" class="form-control w-full bg-gray-50 dark:bg-gray-700 text-gray-800 dark:text-gray-200 p-2 px-1 rounded-md" id="cargaviento" value="75" placeholder="Numero de TRAMOS" min="0" required oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"></th>
                                        <th class="py-2 px-4">Kg/H</th>
                                    </tr>
                                    <tr class="bg-white dark:bg-gray-800">
                                        <th class="py-2 px-4">Carga de nieve </th>
                                        <th class="py-2 px-4">Ps</th>
                                        <th class="py-2 px-4"><input type="text" name="Ps" class="form-control w-full bg-gray-50 dark:bg-gray-700 text-gray-800 dark:text-gray-200 p-2 px-1 rounded-md" id="Ps" value="40" placeholder="Numero de TRAMOS" min="0" required oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"></th>
                                        <th class="py-2 px-4">Kg/m<sup>2</sup></th>
                                    </tr>
                                    <!-- COEFICIENTE SISMICO -->
                                    <th class="py-2 px-4" colspan="4" style="font-size: 1.1rem; font-weight: normal; text-align: left;">
                                    ...
                                    <tr class="bg-white dark:bg-gray-800">
                                        ...
                                        <th class="py-2 px-4"><input type="text" name="U" class="form-control w-full bg-gray-50 dark:bg-gray-700 text-gray-800 dark:text-gray-200 p-2 px-1 rounded-md" id="U" value="1.5" placeholder="Numero de TRAMOS" min="0" required oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"></th>
                                        <th class="py-2 px-4">-</th>
                                    </tr>
                                    <tr class="bg-white dark:bg-gray-800">
    ...
    <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
                                    ...
                                    <script src="assets/js/adm_Arcotecho_general.js"></script>
