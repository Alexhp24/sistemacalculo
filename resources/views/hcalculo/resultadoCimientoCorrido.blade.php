...
<table id="" class="min-w-full text-gray-800 dark:text-white">
    ...
    <thead class="bg-gray-200 dark:bg-gray-800">
        ...
        <tr class="bg-white text-gray-900 dark:bg-gray-800 dark:text-white">
            <th class="text-xl py-2 px-4 text-left" colspan="4">3.1.- Metrados de cargas por el ancho de influencia
                transformada</th>
        </tr>
    </thead>
    <tbody class="bg-gray-100 dark:bg-gray-800  py-2">
    ...
    <tbody class="bg-gray-100 dark:bg-gray-800  py-2">
        ...
        <tr class="bg-white text-gray-900 dark:bg-gray-800 dark:text-white">
            <th class="text-xl py-2 px-4 text-left" colspan="4">4.2 Verificación por corte a flexión (Concreto
                ciclópeo)</th>
        </tr>
        <tr class="bg-gray-100 dark:bg-gray-600">
