<x-app-layout>
                            ...
                            <form action="{{ route('malbaCont') }}" method="POST" id="datamurosAlb">
                                ...
                                <table class="table-auto w-full text-gray-800 dark:text-white px-6">
                                    ...
                                    <tbody class="text-center">
                                        ...
                                        <tr class="bg-white dark:bg-gray-800">
                                            ...
                                            <th class="py-2 px-4">
                                                <input type="text" name="desc"
                                                    ...
                                                    id="desc" placeholder="descripción" min="0" value="desc" required>
                                            </th>
                                            <th class="py-2 px-4"></th>
                                        </tr>
                                        <tr class="bg-white dark:bg-gray-800">
                                            ...
                                            <th class="py-2 px-4">
                                                <input type="text" name="ubi"
                                                    class="form-control w-full bg-gray-50 dark:bg-gray-700 text-gray-800 dark:text-gray-200 p-2 px-1 rounded-md"
                                                    id="ubi" placeholder="Agrega la ubicación" min="0" value="ubi"
                                                    required>
                                            </th>
                                            <th class="py-2 px-4"></th>
                                        </tr>
                                        ...
                                        <tr class="bg-white dark:bg-gray-800">
                                            <th class="py-2 px-4">Resistencia característica corte de la albañilería</th>
                                        ...
                                        <tr class="bg-white dark:bg-gray-800">
                                            <th class="py-2 px-4" colspan="4">7.2 Determinación de la Sección de Concreto de la Columna de Confinamiento</th>
                                        </tr>
                                        <tr class="bg-white dark:bg-gray-800">
                                        ...
                                        <tr class="bg-white dark:bg-gray-800">
                                            ...
                                            <th class="py-2 px-4"><input type="text" name="pci"
                                                    class="form-control w-full bg-gray-50 dark:bg-gray-700 text-gray-800 dark:text-gray-200 p-2 px-1 rounded-md"
                                                    id="pci" value="0.7" placeholder="0.7" min="0" step="any" required>
                                            </th>
                                            <th class="py-2 px-4"></th>
                                        </tr>
                                        <tr class="bg-white dark:bg-gray-800">
                                        ...
                                        <tr class="bg-white dark:bg-gray-800">
                                            <th class="py-2 px-4" colspan="4">8. 7.2 Determinación de la Sección de Concreto de la Columna de Confinamiento</th>
                                        </tr>
                                        <tr class="bg-white dark:bg-gray-800">
    ...
    <script src="{{ asset('assets/js/adm_muros_albanieria.js') }}"></script>
