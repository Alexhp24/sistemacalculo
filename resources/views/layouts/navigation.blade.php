<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <x-logo-empresa class="block h-9 w-auto fill-current text-gray-800 dark:text-gray-200" />
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <div class="hidden sm:flex sm:items-center sm:ms-6">
                        <x-dropdown align="right" width="48">
                            ...
                            <x-slot name="content">
                                <x-dropdown-link :href="url('admDvigas')">
                                    {{ __('Diseño de vigas') }}
                                </x-dropdown-link>
                                <x-dropdown-link :href="url('admvigasG')">
                                    {{ __('vigas General') }}
                                </x-dropdown-link>
                            </x-slot>
                        </x-dropdown>
                    </div>
                    <!-- Hojas de calculo de Losas -->
                    <div class="hidden sm:flex sm:items-center sm:ms-6">
                        <x-dropdown align="right" width="48">
                            <x-slot name="trigger">
                                <button
                            ...
                            <x-slot name="content">
                                <x-dropdown-link :href="url('admlosasaligerada')">
                    ...
                    <!-- Hojas de calculo de Muros de contencion -->
                    <div class="hidden sm:flex sm:items-center sm:ms-6">
                        <x-dropdown align="right" width="48">
                            <x-slot name="trigger">
                                <button
                            ...
                            <x-slot name="content">
                                <x-dropdown-link :href="url('admMurosContencion')">
                                    {{ __('Diseño Muros de Contencion') }}
                                </x-dropdown-link>
                                <x-dropdown-link :href="url('admMalb')">
                                    {{ __('Diseño Muros de albañilería') }}
                                </x-dropdown-link>
                            </x-slot>
                        </x-dropdown>
                    </div> --}}
                    ...
                    <!-- Hoja de calculo de columnas -->
                    <x-nav-link :href="url('admColumna')" :active="request()->is('admColumna*')">
                        {{ __('Columna') }}
                    </x-nav-link>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="url('admCimientoCorrido')" :active="request()->is('admCimientoCorrido')">
                {{ __('Cimiento') }}
            </x-responsive-nav-link>
        </div>
