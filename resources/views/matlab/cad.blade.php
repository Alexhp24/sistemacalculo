...
<body class="antialiased bg-gray-100 dark:bg-gray-900">
                                ...
                                <thead>
                                    ...
                                    <tr class="bg-gray-100 dark:bg-gray-600">
                                        <td id="plot" class="py-2 px-4" colspan="4">
                                            ...
                                            <div class="w-full h-[640px] relative" id="editor"><canvas class="w-full h-full"></canvas>
                                            </div>
                                        </td>
                                    </tr>
                                </thead>
                                <tbody id="polygons"></tbody>
                            </table>
                        </div>
                    </div>
                </div>
    ...
    <script src="{{ asset('assets/js/adm_analisis_estructural_de_armaduras_2.js') }}" type="module"></script>
</body>
