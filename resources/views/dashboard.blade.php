            ...
            <div class="flex flex-wrap">
                <div class="w-full md:w-2/3">
                    <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg p-6">
                        <h2 class="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-4 text-center">Nuestros Aplicativos</h2>
                            ...
                            <div class="container mx-auto px-4">
                                <div class="grid grid-cols-3 gap-4">
                                    <a href="{{url('admMurosContencion')}}">
                                        <div class="card bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                                            <div class="flex items-center">
                                                <svg class="w-10 h-6 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-12 0v1z"></path>
                                                </svg>
                ...
                <div class="w-full md:w-1/3 px-4 mt-4 md:mt-0">
                    <div class="w-96 px-6 py-6  text-center bg-gray-800 rounded-lg lg:mt-0 xl:px-10">
                        <div class="space-y-4 xl:space-y-6">
                            <img class="mx-auto rounded-full h-36 w-36" src="{{ url('/assets/img/avatarra.jpeg') }}" alt="author avatar">
                            <div class="space-y-2">
