document.addEventListener('DOMContentLoaded', function () {
    ...
    function realizarCalculos() {
        ...
        function flexDesing() {
            ...
            <tr class="bg-gray-100 dark:bg-gray-600">
                ...
                <td class='py-2 px-4'></td>
                <td class='py-2 px-4'></td>
                <td class='py-2 px-4' id="sepA">@${resDA}</td>
            </tr>
            <tr class="bg-gray-100 dark:bg-gray-600">
                <td class='py-2 px-4'>Entonces</td>          
                <td class='py-2 px-4'></td>          
                <td class='py-2 px-4'></td>
                <td class='py-2 px-4' id="then">${barras} Φ ${textSelect} @ ${resDA}</td>        
            </tr>`;
    ...
    function selectChange2() {
        ...
        areaAcero.addEventListener('change', function (e) {
            ...
            document.getElementById('seo').innerHTML = `${(value * 100) / as2 > 25 ? 25 : (value / as2).toFixed(2)
                } cm`;
        });
    }
    ...
    function inputChange2() {
        ...
        e.addEventListener('input', function (e) {
            ...
            document.getElementById('seo').innerHTML = `${(selectValue * 100) / as2 > 25 ? 25 : (selectValue / as2).toFixed(2)
                } cm`;
        });
    }
